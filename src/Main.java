public class Main {
    public static void main(String[] args) {
        ...
        ProduktMenu p2 = new ProduktMenu("K-02", "Capuccino", 13.5, "kawa");
        ProduktMenu p3 = new ProduktMenu("D-01", "Sernik", 16.0, "deser");
        ProduktMenu p4 = new ProduktMenu("I-01", "Cygaro", 100.0, "inne");

        KlientKawiarni klient = new KlientKawiarni(100, "Jan", "Kowalski", "j.kowalski@gmail.pl");
        ...
        KlientKawiarni duplikat = new KlientKawiarni(101, "J.", "Kowalski", "j.kowalski@gmail.pl");
        System.out.println("Ten sam klient? " + klient.equals(duplikat));
